      ...
      <main className="relative z-10">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4 font-playfair">Learning Hub</h2>
                <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="content-box-enhanced animate-background-shift animate-staggered-fade-in p-8 lg:p-12">
                <CardContent className="p-0">
                  <div className="text-center mb-8">
                    <h2 className="text-2xl font-bold text-slate-800 mb-4 font-playfair">Core Objectives</h2>
        ...
        <section className="py-12 lg:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-[#1E4B8E] mb-4 font-playfair">Frequently Asked Questions</h2>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <Card className="content-box-enhanced animate-pulse-glow p-12 lg:p-16">
                <CardContent className="p-0">
                  <h2 className="text-3xl lg:text-4xl font-bold text-[#1E4B8E] mb-6 font-playfair">
